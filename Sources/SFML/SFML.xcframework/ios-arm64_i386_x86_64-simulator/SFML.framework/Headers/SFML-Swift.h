...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SFML",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4SFML24SFMLAccessibilityElement")
...
SWIFT_PROTOCOL("_TtP4SFML32SFMLAccessibilityElementDelegate_")
...
SWIFT_CLASS("_TtC4SFML10SFMLAction")
...
/// events.
SWIFT_CLASS("_TtC4SFML13SFMLAnalytics")
...
SWIFT_PROTOCOL("_TtP4SFML25SFMLViewWayfinderDelegate_")
...
@interface SFMLAnalytics (SWIFT_EXTENSION(SFML)) <SFMLViewWayfinderDelegate>
...
SWIFT_PROTOCOL("_TtP4SFML16SFMLViewDelegate_")
...
@interface SFMLAnalytics (SWIFT_EXTENSION(SFML)) <SFMLViewDelegate>
/// :nodoc:
- (void)sfmlViewVisibilityChanged:(SFMLView * _Nonnull)view isVisible:(BOOL)isVisible;
/// :nodoc:
- (void)sfmlViewDidScrollToTop:(SFMLView * _Nonnull)view;
...
SWIFT_CLASS("_TtC4SFML18SFMLAnnotationView")
...
SWIFT_CLASS("_TtC4SFML15SFMLBorderLayer")
...
SWIFT_CLASS("_TtC4SFML33SFMLFlyerViewAccessibilityElement")
...
SWIFT_PROTOCOL("_TtP4SFML21SFMLImageDownloadTask_")
...
SWIFT_PROTOCOL("_TtP4SFML29SFMLImageDownloadTaskProvider_")
...
SWIFT_PROTOCOL("_TtP4SFML16SFMLImageLoading_")
...
SWIFT_CLASS("_TtC4SFML18SFMLItemAttributes")
...
SWIFT_CLASS("_TtC4SFML10SFMLItemID")
...
SWIFT_CLASS("_TtC4SFML8SFMLView")
...
@interface SFMLView (SWIFT_EXTENSION(SFML)) <UIGestureRecognizerDelegate>
/// :nodoc:
...
@interface SFMLView (SWIFT_EXTENSION(SFML)) <UIScrollViewDelegate>
/// :nodoc:
...
SWIFT_PROTOCOL("_TtP4SFML25SFMLViewAnalyticsDelegate_")
...
SWIFT_CLASS("_TtC4SFML18StorefrontSFMLView")
